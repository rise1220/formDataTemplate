...
public class HappyrentDAO extends EgovAbstractDAO {
	...
	public List<?> selectFuel(){
		return list("happyrentDAO.selectfuel");
		
	}
	
	public String dbTime(){
		return (String) select("happyrentDAO.dbTime");
	}
	
	public List<?> selectList(HappyrentDefaultVO vo){
		return list("happyrentDAO.selectList", vo);
	}
	
	public int selectCount(HappyrentDefaultVO vo){
		return (int) select("happyrentDAO.selectCount", vo);
	}
